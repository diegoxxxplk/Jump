...
-- Função para ativar skill diretamente
local function pressSkill(id)
    -- Aqui, idealmente, chamar diretamente a função do jogo que ativa a skill id
    -- Como não temos acesso, vamos tentar disparar um evento remoto, se houver, ou ignorar no celular
    -- Para teste, vamos só printar
    print("Skill ativada:", id)
end
